...
if ( ! function_exists( 'tmpcoder_add_customizer_options' ) ) {
    ...
    function tmpcoder_add_customizer_options($redux_data){
        if( ! class_exists('Redux_Framework_Plugin', false) ) {
            ...
            $redux_data['container_width'] = isset($tmpcoderThemeMods['container_width']) ? $tmpcoderThemeMods['container_width'] : '1200';
            $redux_data['container_width_tablet'] = isset($tmpcoderThemeMods['container_width_tablet']) ? $tmpcoderThemeMods['container_width_tablet'] : '1000';
            $redux_data['container_width_mobile'] = isset($tmpcoderThemeMods['container_width_mobile']) ? $tmpcoderThemeMods['container_width_mobile'] : '500';
            ...
            $redux_data['button_style']['text-align'] = isset($tmpcoderThemeMods['button_style_text-align']) ? $tmpcoderThemeMods['button_style_text-align'] : 'center';
            $redux_data['button_style']['text-transform'] = isset($tmpcoderThemeMods['button_style_text-transform']) ? $tmpcoderThemeMods['button_style_text-transform'] : 'uppercase';
            $redux_data['button_style']['font-size'] = isset($tmpcoderThemeMods['button_style_font-size']) ? $tmpcoderThemeMods['button_style_font-size'].'px'  : '16px';
            $redux_data['button_style']['line-height'] = isset($tmpcoderThemeMods['button_style_line-height']) ? $tmpcoderThemeMods['button_style_line-height']  : '1';
            ...
            $redux_data['site_button_text_hover'] = isset($tmpcoderThemeMods['site_button_text_hover']) ? $tmpcoderThemeMods['site_button_text_hover']  : '#6192f8';
            $redux_data['site_button_color'] = isset($tmpcoderThemeMods['site_button_color']) ? $tmpcoderThemeMods['site_button_color']  : '#6192f8';
            ...
            $redux_data['button_border']['border-color'] = isset($tmpcoderThemeMods['button_border_border-color']) ? $tmpcoderThemeMods['button_border_border-color']  : '#6192f8';
            ...
            $redux_data['button_border_hover']['border-color'] = isset($tmpcoderThemeMods['button_border_hover_border-color']) ? $tmpcoderThemeMods['button_border_hover_border-color']  : '#6192f8';
            ...
            $redux_data['site_fonts_options']['font-size'] = isset($tmpcoderThemeMods['site_fonts_options_font-size']) ? $tmpcoderThemeMods['site_fonts_options_font-size'].'px' : '14px';
            ...
            $redux_data['site_fonts_options']['color'] = isset($tmpcoderThemeMods['site_fonts_options_color']) ? $tmpcoderThemeMods['site_fonts_options_color'] : '#777777';
            ...
            for ($i = 1; $i <= 6; $i++) {
                if (!empty($tmpcoderThemeMods['heading_'.$i.'_font-family'])) {
                    ...
                    // $redux_data['heading_'.$i]['font-family'] = $heading_defaults[$i]['font-family'];
                    $redux_data['heading_'.$i]['font-weight'] = $heading_defaults[$i]['font-weight'];
                }

                $redux_data['heading_'.$i]['text-transform'] = isset($tmpcoderThemeMods['heading_'.$i.'_text-transform']) ? $tmpcoderThemeMods['heading_'.$i.'_text-transform'] : $heading_defaults[$i]['text-transform'];
                $redux_data['heading_'.$i]['font-size'] = isset($tmpcoderThemeMods['heading_'.$i.'_font-size']) ? $tmpcoderThemeMods['heading_'.$i.'_font-size'].'px' : $heading_defaults[$i]['font-size'];
                $redux_data['heading_'.$i]['line-height'] = isset($tmpcoderThemeMods['heading_'.$i.'_line-height']) ? $tmpcoderThemeMods['heading_'.$i.'_line-height'] : $heading_defaults[$i]['line-height'];
                $redux_data['heading_'.$i]['letter-spacing'] = isset($tmpcoderThemeMods['heading_'.$i.'_letter-spacing']) ? $tmpcoderThemeMods['heading_'.$i.'_letter-spacing'].'px' : $heading_defaults[$i]['letter-spacing'];
                $redux_data['heading_'.$i]['color'] = isset($tmpcoderThemeMods['heading_'.$i.'_color']) ? $tmpcoderThemeMods['heading_'.$i.'_color'] : $heading_defaults[$i]['color'];
            ...
            for ($i = 1; $i <= 6; $i++) {
                $redux_data['heading_'.$i.'_tablet']['font-size'] = isset($tmpcoderThemeMods['heading_'.$i.'_tablet_font-size']) ? $tmpcoderThemeMods['heading_'.$i.'_tablet_font-size'].'px' : $heading_defaults_tablet[$i]['font-size'];
                $redux_data['heading_'.$i.'_tablet']['line-height'] = isset($tmpcoderThemeMods['heading_'.$i.'_tablet_line-height']) ? $tmpcoderThemeMods['heading_'.$i.'_tablet_line-height'] : $heading_defaults_tablet[$i]['line-height'];
                $redux_data['heading_'.$i.'_tablet']['letter-spacing'] = isset($tmpcoderThemeMods['heading_'.$i.'_tablet_letter-spacing']) ? $tmpcoderThemeMods['heading_'.$i.'_tablet_letter-spacing'].'px' : $heading_defaults_tablet[$i]['letter-spacing'];
            }

            // Theme font & heading style for tablet
            $redux_data['site_fonts_options_mobile']['font-size'] = isset($tmpcoderThemeMods['site_fonts_options_mobile_font-size']) ? $tmpcoderThemeMods['site_fonts_options_mobile_font-size'].'px' : '14px';
            $redux_data['site_fonts_options_mobile']['line-height'] = isset($tmpcoderThemeMods['site_fonts_options_mobile_line-height']) ? $tmpcoderThemeMods['site_fonts_options_mobile_line-height'] : '1.5';
            ...
            for ($i = 1; $i <= 6; $i++) {
                $redux_data['heading_'.$i.'_mobile']['font-size'] = isset($tmpcoderThemeMods['heading_'.$i.'_mobile_font-size']) ? $tmpcoderThemeMods['heading_'.$i.'_mobile_font-size'].'px' : $heading_defaults_mobile[$i]['font-size'];
                $redux_data['heading_'.$i.'_mobile']['line-height'] = isset($tmpcoderThemeMods['heading_'.$i.'_mobile_line-height']) ? $tmpcoderThemeMods['heading_'.$i.'_mobile_line-height'] : $heading_defaults_mobile[$i]['line-height'];
                $redux_data['heading_'.$i.'_mobile']['letter-spacing'] = isset($tmpcoderThemeMods['heading_'.$i.'_mobile_letter-spacing']) ? $tmpcoderThemeMods['heading_'.$i.'_mobile_letter-spacing'].'px' : $heading_defaults_mobile[$i]['letter-spacing'];
            }
